...
export default function SharePost({
  ...
  const createPost = async () => {
    console.log(title, category, tags, status, contactContent, intro, content, year);
    let split_tags;
    if (tags === '') {
      split_tags = [];
    }else{
  ...
  return (
    <div>
      ...
      <PageBackground>
        ...
        >
          <GridItem colStart={1}>
            <Button size='md' variant='solid' style={btnStyle} onClick={handleToShare} disabled={titleLong || introLong}>發布貼文</Button>
          </GridItem>
        </Grid>
        <Grid
            templateColumns='repeat(12, 1fr)'
            ...
            <GroupBackgroud>
              ...
              >
                <GridItem colStart={1}>
                  ...
                  <p className='hint hidden' style={{marginTop: '-2vh', marginBottom: '2vh', visibility: 'hidden'}}>.<span style={{color: 'red'}}></span></p>
                  <InputGroup style = {inputGroupStyle}>
                    <InputLeftAddon style={leftStyle} backgroundColor='#001C55' color='white'>
                ...
                <InputGroup style = {inputGroupStyle}>
                  ...
                  <InputGroup style = {inputGroupStyle}>
                    ...
                    <Input onChange={(e) => {setContactContent(e.target.value)}}/>
                  </InputGroup>
              ...
              >
                <GridItem colSpan={12} justifySelf="center">
                  ...
                  <Textarea onChange={(e) => {setIntro(e.target.value)}} placeholder='輸入文章簡介' style={textAreaStyle_intro} />
                  <p className='hint'><span style={{color: 'red'}}>*</span>請勿填寫超過80個字元</p>
                  <p style={hStyle}>文章內容</p>
                  <Textarea onChange={(e) => {setContent(e.target.value)}} placeholder='輸入文章內容' style={textAreaStyle} />
                </GridItem>
              </Grid>  
            </GroupBackgroud>
          </GridItem>
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <Button onClick={() => {setToShare(false)}}>
                取消
              </Button>
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <Button onClick={() => {setToLeave(false)}}>
                取消
              </Button>
              <Button ml={3}>
                離開
